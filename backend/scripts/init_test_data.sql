...
SELECT 'TK202607050001', 'leave_request', '年假申请', '申请年假，需要回家处理个人事务', 'completed', @user_zhangsan, NULL, '已批准', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050001');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050002', 'certify', '在职证明申请', '需要开具在职证明用于办理签证', 'pending', @user_zhangsan, NULL, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050002');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050003', 'info_change', '手机号码变更', '更换了新的手机号码', 'completed', @user_zhangsan, NULL, '已更新系统信息', DATE_SUB(NOW(), INTERVAL 1 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050004', 'attendance_exception', '忘打卡申请', '早上忘记打卡', 'pending', @user_lisi, @user_zhangsan, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050004');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050005', 'reimbursement', '差旅费报销', '出差期间产生的差旅费用', 'completed', @user_lisi, @user_zhangsan, '已审批通过', DATE_SUB(NOW(), INTERVAL 3 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050005');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050006', 'other', 'IT设备申请', '申请新的笔记本电脑', 'pending', @user_lisi, @user_zhangsan, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050007', 'leave_request', '病假申请', '身体不适，需要休息', 'completed', @user_wangwu, @user_zhangsan, '已批准', DATE_SUB(NOW(), INTERVAL 5 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050007');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050008', 'certify', '收入证明申请', '需要开具收入证明用于办理贷款', 'pending', @user_wangwu, @user_zhangsan, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050009', 'leave_request', '事假申请', '家中有事需要处理', 'pending', @user_liudehua, NULL, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050009');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050010', 'info_change', '银行卡号变更', '更换工资卡', 'completed', @user_liudehua, NULL, '已更新系统信息', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050011', 'attendance_exception', '迟到说明', '今天迟到需要说明原因', 'pending', @user_zhangxueyou, @user_liudehua, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050011');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050012', 'reimbursement', '办公用品报销', '购买办公用品费用', 'completed', @user_zhangxueyou, @user_liudehua, '已审批通过', DATE_SUB(NOW(), INTERVAL 4 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050012');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050013', 'other', '会议室预定', '需要预定会议室', 'pending', @user_zhangxueyou, @user_liudehua, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050014', 'leave_request', '年假申请', '申请年假休息', 'completed', @user_guofucheng, @user_liudehua, '已批准', DATE_SUB(NOW(), INTERVAL 3 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050014');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050015', 'certify', '在职证明申请', '需要开具在职证明', 'pending', @user_guofucheng, @user_liudehua, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050016', 'info_change', '手机号码变更', '更换了新的手机号码', 'completed', @user_liming, @user_liudehua, '已更新系统信息', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050016');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050017', 'attendance_exception', '忘打卡申请', '早上忘记打卡', 'pending', @user_liming, @user_liudehua, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050018', 'reimbursement', '差旅费报销', '出差期间产生的差旅费用', 'pending', @user_zhoujielun, @user_liudehua, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050018');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050019', 'leave_request', '事假申请', '家中有急事', 'completed', @user_zhoujielun, @user_liudehua, '已批准', DATE_SUB(NOW(), INTERVAL 1 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050020', 'other', 'IT设备申请', '申请新的显示器', 'pending', @user_linjunjie, @user_liudehua, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050020');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050021', 'certify', '收入证明申请', '需要开具收入证明', 'pending', @user_linjunjie, @user_liudehua, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050022', 'leave_request', '年假申请', '申请年假', 'completed', @user_chenglong, NULL, '已批准', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050022');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050023', 'info_change', '银行卡号变更', '更换工资卡', 'pending', @user_chenglong, NULL, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050024', 'attendance_exception', '迟到说明', '地铁故障导致迟到', 'pending', @user_lianjie, @user_chenglong, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050024');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050025', 'reimbursement', '差旅费报销', '出差费用报销', 'completed', @user_lianjie, @user_chenglong, '已审批通过', DATE_SUB(NOW(), INTERVAL 3 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050026', 'leave_request', '病假申请', '身体不适', 'completed', @user_zhenzidan, @user_chenglong, '已批准', DATE_SUB(NOW(), INTERVAL 4 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050026');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050027', 'certify', '在职证明申请', '需要开具在职证明', 'pending', @user_zhenzidan, @user_chenglong, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050028', 'other', '会议室预定', '需要预定会议室', 'pending', @user_wuyanzu, @user_chenglong, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050028');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050029', 'info_change', '手机号码变更', '更换手机号码', 'completed', @user_wuyanzu, @user_chenglong, '已更新系统信息', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050030', 'attendance_exception', '忘打卡申请', '早上忘记打卡', 'pending', @user_pengyuyan, @user_chenglong, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050030');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050031', 'leave_request', '事假申请', '需要处理私事', 'completed', @user_pengyuyan, @user_chenglong, '已批准', DATE_SUB(NOW(), INTERVAL 3 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050032', 'leave_request', '年假申请', '申请年假', 'pending', @user_yangmi, NULL, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050032');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050033', 'certify', '收入证明申请', '需要开具收入证明', 'completed', @user_yangmi, NULL, '已开具', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050034', 'reimbursement', '差旅费报销', '出差费用报销', 'pending', @user_zhaoliying, @user_yangmi, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050034');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050035', 'info_change', '银行卡号变更', '更换工资卡', 'completed', @user_zhaoliying, @user_yangmi, '已更新系统信息', DATE_SUB(NOW(), INTERVAL 3 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050036', 'attendance_exception', '忘打卡申请', '早上忘记打卡', 'pending', @user_tangyan, @user_yangmi, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050036');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050037', 'leave_request', '病假申请', '身体不适', 'completed', @user_tangyan, @user_yangmi, '已批准', DATE_SUB(NOW(), INTERVAL 4 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050038', 'other', 'IT设备申请', '申请新的键盘鼠标', 'pending', @user_liushishi, @user_yangmi, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050038');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050039', 'certify', '在职证明申请', '需要开具在职证明', 'completed', @user_liushishi, @user_yangmi, '已开具', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050040', 'leave_request', '事假申请', '家中有事', 'pending', @user_huangbo, NULL, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050040');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050041', 'info_change', '手机号码变更', '更换手机号码', 'completed', @user_huangbo, NULL, '已更新系统信息', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050042', 'attendance_exception', '迟到说明', '交通堵塞', 'pending', @user_xuzheng, @user_huangbo, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050042');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050043', 'reimbursement', '办公用品报销', '购买办公用品', 'completed', @user_xuzheng, @user_huangbo, '已审批通过', DATE_SUB(NOW(), INTERVAL 3 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050044', 'leave_request', '年假申请', '申请年假', 'pending', @user_wangbaoqiang, @user_huangbo, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050044');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050045', 'other', '会议室预定', '需要预定会议室', 'completed', @user_wangbaoqiang, @user_huangbo, '已预定', DATE_SUB(NOW(), INTERVAL 1 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
...
INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050046', 'certify', '收入证明申请', '需要开具收入证明', 'pending', @user_dengchao, @user_huangbo, NULL, NULL, UUID(), DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY)
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM biz_ticket WHERE ticket_no = 'TK202607050046');

INSERT INTO biz_ticket (ticket_no, type, title, description, status, creator_id, assignee_id, resolve_note, resolved_at, conversation_id, created_at, updated_at)
SELECT 'TK202607050047', 'info_change', '银行卡号变更', '更换工资卡', 'completed', @user_dengchao, @user_huangbo, '已更新系统信息', DATE_SUB(NOW(), INTERVAL 2 DAY), UUID(), DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)
FROM DUAL
