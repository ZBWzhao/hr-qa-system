...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'rules', name: 'Rules', component: () => import('../views/Rules.vue'), meta: { title: '规则问答', roles: ['hr', 'admin'] } },
      ...
      { path: 'statistics', name: 'Statistics', component: () => import('../views/Statistics.vue'), meta: { title: '数据统计', roles: ['hr', 'admin'] } },
      { path: 'gaps', name: 'Gaps', component: () => import('../views/Gaps.vue'), meta: { title: '知识缺口', roles: ['hr', 'admin'] } },
      { path: 'roi', name: 'ROI', component: () => import('../views/ROI.vue'), meta: { title: 'ROI分析', roles: ['hr', 'admin'] } },
